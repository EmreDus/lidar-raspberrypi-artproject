#version 0.1 ---> haberlesme yok - music loop yok - lidar mirror angle yanlis hesaplama duzeltildi.
...
media = vlc.MediaPlayer("/home/lidar/project/Platform 1.wav")
media.play()
#media = AudioPlayer("Platform 1.wav")
